...
import ProgressWave from '../ui/ProgressWave';
...
const TimerCard = ({
    ...
    const [isManualChip, setIsManualChip] = useState(false);
    ...
    const CompactTimeChip = useMemo(() => memo(() => {
        ...
        const updateTimeParts = useCallback(() => {
            ...
            if (defaultUnit === 'auto' && !isManualChip) {
    ...
    }), [defaultUnit, colors, styles, getChippedTime, timer, isManualChip]);
