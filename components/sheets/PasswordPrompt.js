...
import { getStrength } from '../../utils/text/passwordStrength';
...
export default function PasswordPrompt({
    ...
    const handleSave = () => {
        ...
        if (strength.score < 80) {
            setError(`Password is not strong enough. Please aim for a score of at least 80. Your current score is ${strength.score}.`);
            return;
        }
