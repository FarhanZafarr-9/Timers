...
export const changelog = [
    ...
    },
    {
        "version": "1.1.2",
        "date": "2025-07-26",
        "title": "Performance, Timer & Visual Improvements",
        "major": true,
        "changes": [
            { "type": "new", "text": "Added intelligent mode constraints (Countdown/Countup) while creating timers" },
            { "type": "new", "text": "Integrated proper date-time picker for a smoother timer setup experience" },

            { "type": "improved", "text": "Rebuilt timer time calculations and notification handling using day.js for accuracy and better performance" },
            { "type": "improved", "text": "Timer reminders system in progress; groundwork laid for second-accurate triggers" },
            { "type": "improved", "text": "QR sharing reliability enhanced – scanning and generation are now more robust" },
            { "type": "improved", "text": "Improved privacy mode visibility and behavior across timer and settings screens" },
            { "type": "improved", "text": "Theme system redesigned to use a base color and derive all related colors instead of hardcoding" },
            { "type": "improved", "text": "UI consistency and spacing tweaks for a more polished visual experience" },

            { "type": "fixed", "text": "Fixed rare crashes and issues during encrypted timer imports" },
            { "type": "fixed", "text": "Addressed bugs in timer restarts and state transitions during recurring cycles" },

            {
                "type": "summarized",
                "text": "Major under-the-hood optimizations using day.js, better timer creation logic, improved themes, QR and privacy fixes, and strong performance gains."
            }
        ]
    },
    {
